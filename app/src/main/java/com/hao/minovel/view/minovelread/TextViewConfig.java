...
//    }
//
//    static TextViewConfig miTextViewConfig;
//
//    public static TextViewConfig getDefoutConfig() {
//        if (miTextViewConfig == null) {
//            miTextViewConfig = new TextViewConfig();
...
//            miTextViewConfig.titleSize = miTextViewConfig.textSize = SystemUtil.sp2px(AppContext.application, 21f);
//
...
//    }
//
//    public static TextViewConfig getDefoutConfig(float viewWidth, float viewhigh) {
//        if (miTextViewConfig == null) {
//            getDefoutConfig();
...
//
//
//    private TextViewConfig initViewConfig() {
//        if (viewhigh == 0 || viewWidth == 0) {
...
//    }
//
//    public TextViewConfig setViewWiHi(float viewWidth, float viewhigh) {
